...
export default function HeroSection() {
  return (
    <section id="home" className="min-h-screen py-16 lg:py-0  text-slate-100 flex items-center justify-center font-mono relative overflow-hidden">
      <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-sky-500/10 blur-[140px] rounded-full pointer-events-none" />
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10">
        ...
        <div className="lg:col-span-7 text-center lg:text-left space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight">
            Hi, I'm <span className="text-sky-400">Sushil</span>
          </h1>
          ...
          <div className="pt-2 flex flex-col flex-wrap items-start justify-center lg:justify-start gap-4">
            <div className="inline-flex items-center gap-2  py-1  rounded-full text-xs text-gray-400">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-6 py-3 bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold rounded-lg text-sm transition-all duration-200 shadow-lg shadow-sky-500/20 active:scale-95"
              >
              ...
              <Button
                asChild
                className="bg-sky-300 text-slate-950 hover:bg-sky-400 font-bold px-4 py-2.5 rounded-lg transition-all duration-200 shadow-lg shadow-sky-500/20 active:scale-95 text-sm"
              >
                <a
          ...
          <div className="relative group flex items-center justify-center">
            ...
            <div className="absolute w-[340px] h-[340px] sm:w-[380px] sm:h-[380px] lg:w-[440px] lg:h-[440px] rounded-full border border-sky-500/20 animate-[spin_20s_linear_infinite]">
              ...
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-900 border border-sky-500/40 p-2 rounded-full shadow-lg shadow-sky-500/20">
                <Atom className="w-5 h-5 text-sky-400 animate-[spin_10s_linear_infinite_reverse]" />
              </div>
              {/* Planet 2 */}
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-slate-900 border border-teal-500/40 p-2 rounded-full shadow-lg shadow-teal-500/20">
                <Terminal className="w-5 h-5 text-teal-400 animate-[spin_10s_linear_infinite_reverse]" />
              </div>
            </div>

            {/* Orbit Ring 2 - Inner Counter-Rotating Orbit */}
            <div className="absolute w-[300px] h-[300px] sm:w-[340px] sm:h-[340px] lg:w-[390px] lg:h-[390px] rounded-full border border-dashed border-teal-500/30 animate-[spin_15s_linear_infinite_reverse]">
              {/* Planet 3 */}
              <div className="absolute top-1/2 -left-3 -translate-y-1/2 bg-slate-900 border border-sky-400/40 p-2 rounded-full shadow-lg shadow-sky-400/20">
                <Cpu className="w-5 h-5 text-sky-300 animate-[spin_15s_linear_infinite]" />
              </div>
            </div>

            {/* Glowing Backdrop Ring */}
            <div className="absolute -inset-1 bg-gradient-to-r from-sky-500 to-teal-500 rounded-full blur-md opacity-40 group-hover:opacity-75 transition duration-300" />
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-2 right-2 z-10 bg-slate-900/90 border border-slate-800 backdrop-blur-md p-3 rounded-xl flex items-center gap-2.5 shadow-xl">
