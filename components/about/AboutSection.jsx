        ...
        <div className="max-w-3xl mx-auto bg-gray-800 border  rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm">
          ...
          <div className="bg-slate-950 border-b border-slate-800 px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="w-6 h-3 rounded-full bg-red-500/80 inline-block" />
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-6 border-b border-slate-800">
              ...
              <div>
                <div className="flex items-center gap-3 p-3  rounded-xl">
                  <div className="text-xs">
                    <p className="font-semibold text-slate-200">Bachelor's in Computer Science(BSc.CSIT)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 text-sm sm:text-base leading-relaxed text-slate-300 font-sans">
              <p>
                Hello! I'm <span className="text-emerald-400 font-mono font-semibold">Sushil Bhattarai</span>, a developer focused on building modern web software and exploring core programming logic.
              </p>
            ...
            <div className="pt-4 flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-3.5 py-1.5 bg-emerald-950/40 border border-emerald-800/50 rounded-full text-xs text-emerald-300 font-mono">
